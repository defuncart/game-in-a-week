...
namespace DeFuncArt.Serialization
{
	...
	{
		/// <summary>Loads an instance of the class T from file.</summary>
		...
		/// <summary>Saves an instance of the class T to file.</summary>
		...
		/// <summary>Determines whether a file exists at a given filepath.</summary>
		...
		/// <summary>Determines whether a file with a given filename exists.</summary>
		...
		/// <summary>Deletes a file with a given filename.</summary>
		/// <param name="filename">Filename of the file.</param>
		...
		/// <summary>Determines the correct filepath for a filename. In UNITY_EDITOR this is in the project's root
